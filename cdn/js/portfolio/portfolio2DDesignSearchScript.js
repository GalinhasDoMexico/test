document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolio = [
      {
        ...
        description: 'Relacionado ao Premium da bot FoxyBot',
...

      {
        ...
        description: 'Relacionado ao Premium da bot FoxyBot',
        date: 'Criado dia: Domingo, 8 de outubro de 2023, 13:47:39',
      ...
      {
        title: 'Foxy Donate',
        description: 'Relacionado ao Donate da bot FoxyBot',
        date: 'Criado dia: Sábado, 7 de outubro de 2023, 22:16:45',
    ...
    // Discord Server
      {
        title: 'Foxy "Regras"',
        description: '<b>[NÃO USADO]</b> Banner para canal de texto de Regras no servidor do Discord da Foxy',
      ...
      {
        title: 'Foxy "Feedback"',
        description: '<b>[NÃO USADO]</b> Banner para canal de texto de Feedback no servidor do Discord da Foxy',
        date: 'Criado dia: Não informado',
      ...
      {
        title: 'Foxy "Donate"',
        description: '<b>[NÃO USADO]</b> Banner para canal de texto de Donate no servidor do Discord da Foxy',
        date: 'Criado dia: Não informado',
...

      {
        ...
        description: '<b>[TEMPORARIAMENTE NÃO USADO]</b> Banner para canal de texto de Diretrizes <br> no meu servidor do Discord',
        date: 'Criado dia: Não informado',
...

      {
        ...
        description: '<b>[TEMPORARIAMENTE NÃO USADO]</b> Banner para canal de texto de Diretrizes <br> do Suporte no meu servidor do Discord',
        date: 'Criado dia: Não informado',
...

      {
        ...
        description: '<b>[TEMPORARIAMENTE NÃO USADO]</b> Banner para canal de texto de VIPs <br> no meu servidor do Discord',
        date: 'Criado dia: Não informado',
