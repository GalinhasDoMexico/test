document.addEventListener('DOMContentLoaded', function() {
    ...
    const frasesSemImagem = [
      "Sometimes not looking back is the best option",
      "Never hide your feelings, it can hinder you later <br> on or you may regret not saying it",
      "I see you, me from the past, and I see how beautiful my life was",
      "Sometimes we may think that death is an option, <br> but in fact, it never has been",
      "Ok Google, how to stop suffering?"
    ];
